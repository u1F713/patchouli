...
`lf` support a "previewer" script that will run each time we hover on a file.
You can optionally use a [shebang](<https://en.wikipedia.org/wiki/Shebang_(Unix)>)
...
make or life a litter be easier.
